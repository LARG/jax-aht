...
from envs.rddl.grid_4x4_alternating.Grid4x4MultiAgentViz import Grid4x4MultiAgentVisualizer

class Grid4x4AlternatingWrapper(BaseEnv):
    ...
    def __init__(self, *args, **kwargs):
        ...
        if self._render:
            self.render_name = kwargs.get('render_name', "grid_4x4_alternating")
