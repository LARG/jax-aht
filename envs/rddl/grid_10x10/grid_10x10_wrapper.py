...
from envs.rddl.grid_10x10.Grid10x10MultiAgentViz import Grid10x10MultiAgentVisualizer

class Grid10x10Wrapper(BaseEnv):
    ...
    def __init__(self, *args, **kwargs):
        ...
        if self._render:
            self.render_name = kwargs.get('render_name', "grid_10x10")
