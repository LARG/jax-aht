...
DEFAULT_WANDB_PROJECT = os.environ.get("WANDB_PROJECT", "NEURIPS-2026-PIZZA")
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--output",
        type=str,
        default="neurips_eval_pizza_variance.html",
    ...
    parser.add_argument(
        "--data-cache",
        type=str,
        default="plotting_data/neurips_eval_pizza_cache.pkl",
...
def main() -> None:
    ...
    #             "$nin": ["OLD", "centralized", "curriculum"],
    #         }
    #     })
