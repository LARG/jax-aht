...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--output",
        type=str,
        default="neurips_pizza_variance.html",
    ...
    parser.add_argument(
        "--data-cache",
        type=str,
        default="plotting_data/neurips_pizza_cache.pkl",
...
def main() -> None:
    ...
    # (Social law yielding variants are not used for pizza)
    ...
    # (No yielding variants for pizza)
    ...
    # (No MAPPO social-law-yielding variant for pizza)
    ...
    # (No MAPPO yielding runs for pizza)
    ...
    # (PPO social-law-yielding variant omitted for pizza)
    ...
    # (No PPO yielding runs for pizza)
    ...
    if args.data_cache and os.path.exists(args.data_cache) and not args.refresh_data_cache:
        ...
        # (Yielding variants omitted for pizza cache)
        loaded_cache = True
    ...
    # (IPPO yielding variants omitted for pizza)
    ...
    # (MAPPO yielding variants omitted for pizza)
    ...
    # (PPO yielding variants omitted for pizza)
    ...
    for agent_label in agents:
        ...
        # (Yielding variants omitted for pizza)
