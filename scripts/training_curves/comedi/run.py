"""CLI: fetch + plot CoMeDi training curves for a task."""
...
from scripts.training_curves.comedi.plot import plot_comedi_run
...
def main():
    ...
    p.add_argument("--out-dir", default="results/figures/training_curves/comedi")
    p.add_argument("--force-recompute", action="store_true")
    args = p.parse_args()

    runs = fetch_comedi_curves_for_task(
        task=args.task,
        entity=args.entity,
    ...
    for r in runs:
        ...
        plot_comedi_run(r, out_dir / fname)
