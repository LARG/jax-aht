...
def run_single_episode(rng, env, optimal_env, agent_idx, agent_params, agent_policies,
    ...
    def get_agent_0_optimal():
        act, hstate = agent_0_vf_policy.get_action(
            params=agent_0_vf_params,
            obs=init_opt_obs_0,
    ...
    def get_agent_1_optimal():
        act, hstate = agent_1_vf_policy.get_action(
            params=agent_1_vf_params,
            obs=init_opt_obs_1,
    ...
    def optimal_scan_step(carry, _):
        def take_optimal_step(carry_step):
            ...
            def get_agent_0_optimal_step():
                act, hstate_next = agent_0_vf_policy.get_action(
                    params=agent_0_vf_params,
                    obs=obs_0,
            ...
            def get_agent_1_optimal_step():
                act, hstate_next = agent_1_vf_policy.get_action(
                    params=agent_1_vf_params,
                    obs=obs_1,
