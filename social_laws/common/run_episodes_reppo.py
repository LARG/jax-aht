...
def run_single_episode(rng, env, agent_idx, agent_param, agent_policy,
    ...
    ep_ts = 1
    init_carry = (ep_ts, env_state, obs, rng, done, reward, env_act_onehot, init_hstate, dummy_info)
    def scan_step(carry, _):
        def take_step(carry_step):
            ...
            return (ep_ts + 1, env_state_next, obs_next, rng, done_next, reward, env_act_onehot, init_hstate, info_next)
