...
from social_laws.initialize_agents import initialize_dqn_actor_critic_fqe_agent
...
def log_metrics(env, config, train_out, logger, metric_names: tuple, agent_idx: int):
    ...
    all_timesteps = all_timesteps.squeeze()  # shape (num_updates,)
    all_n_updates = all_n_updates.squeeze()  # shape (num_updates,)
