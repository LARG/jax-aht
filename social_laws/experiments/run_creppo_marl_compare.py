...
# PYTHONPATH=/home/rolando/GitHub/SOCIAL_LAWS_JAHT JAX_TRACEBACK_FILTERING=off XLA_PYTHON_CLIENT_PREALLOCATE=false python social_laws/experiments/run_creppo_marl_compare.py task=rddl/grid_10x10_alternating/toroidal_no_restrictions_single_task algorithm=creppo/rddl/grid_10x10_alternating/toroidal_full_restrictions algorithm.TRAIN_SEED=72128 algorithm.USE_SAME_SEED=true algorithm.FIXED_EVAL=true
